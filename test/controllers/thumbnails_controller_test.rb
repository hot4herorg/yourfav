...
class ThumbnailsControllerTest < ActionController::TestCase
  ...
  test "should create thumbnail" do
    assert_difference('Thumbnail.count') do
      post :create, thumbnail: { alt: @thumbnail.alt, caption: @thumbnail.caption, image: @thumbnail.image, title: @thumbnail.title }
    end
  ...
  test "should update thumbnail" do
    patch :update, id: @thumbnail, thumbnail: { alt: @thumbnail.alt, caption: @thumbnail.caption, image: @thumbnail.image, title: @thumbnail.title }
    assert_redirected_to thumbnail_path(assigns(:thumbnail))
  end
